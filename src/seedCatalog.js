...
export const SEED_ITEMS = [
  ...
  { categoryId: 'fruit', name: 'lemons',     starred: true  },
  { categoryId: 'fruit', name: 'avocados',    starred: true  },
  ...
  { categoryId: 'fruit', name: 'oranges',     starred: false },
  ...
  { categoryId: 'vegetable', name: 'garlic',        starred: true  },
  ...
  { categoryId: 'vegetable', name: 'spinach',       starred: true  },
  { categoryId: 'vegetable', name: 'bell peppers',  starred: true  },
  { categoryId: 'vegetable', name: 'broccoli',      starred: true  },
  { categoryId: 'vegetable', name: 'cucumbers',     starred: true  },
  ...
  { categoryId: 'seafood', name: 'shrimp',     starred: false },
  { categoryId: 'seafood', name: 'tuna steak', starred: false },
  { categoryId: 'seafood', name: 'cod',        starred: false },
  { categoryId: 'seafood', name: 'tilapia',    starred: false },

  // deli meat
  { categoryId: 'deli-meat', name: 'turkey slices', starred: false },
  { categoryId: 'deli-meat', name: 'ham slices',    starred: false },
  ...
  { categoryId: 'plant-protein', name: 'Beyond burger',    starred: false },
  { categoryId: 'plant-protein', name: 'Impossible ground',starred: false },
  ...
  { categoryId: 'cheese', name: 'sliced cheese', starred: false },
